...
class ContinuousCarRadarEnv:
    ...
    def step(self, action):
        ...
        if self.half_lap == False:
            if (self.start_pos_y + 2 > self.car_y > self.start_pos_y - 2) and (self.center[0] - self.radius < self.car_x < self.center[0] - self.radius + self.path_thickness):
                self.half_lap = True
        ...
        if (self.half_lap == True) and (self.three_quarter_lap == False):
            if (self.start_pos_y + self.radius - self.path_thickness < self.car_y < self.start_pos_y + self.radius) and (self.center[0] - 2 < self.car_x < self.center[0] + 2):
        ...
        if self.half_lap == True and self.three_quarter_lap == True:
            ...
            if (self.start_pos_y - 2 < self.car_y < self.start_pos_y + 2) and (self.center[0] + self.radius - self.path_thickness < self.car_x < self.center[0] + self.radius) :
